...
export type ProductContent = {
   ...
   * per-product template in src/lib/seo.ts. Titles stay within ~45 characters
   * because the layout appends " | MP MedPharma"; descriptions within ~160.
   */
  seoTitle?: string;
  seoDesc?: string;
  description: string;
...
export const PRODUCT_CONTENT: ProductContent[] = [
  ...
  {
    match: ["cirrus", "4000"],
    seoTitle: "Zeiss Cirrus HD-OCT 4000 for Sale",
    seoDesc: "Refurbished Zeiss Cirrus HD-OCT 4000 spectral-domain OCT with macular cube and RNFL analysis for retina and glaucoma clinics. Warranty included. Get a quote.",
  ...
  {
    match: ["solo"],
    seoTitle: "Ellex Solo SLT Laser for Sale",
    seoDesc: "Ellex Solo dedicated 532 nm SLT laser for sale, for selective laser trabeculoplasty in open-angle glaucoma. Refurbished, calibrated and warranted. Get a quote.",
  ...
  {
    match: ["superq"],
    seoTitle: "Ellex Super Q YAG Laser for Sale",
    seoDesc: "Ellex Super Q Nd:YAG ophthalmic laser for sale, for posterior capsulotomy and peripheral iridotomy. Refurbished, calibrated and warranted. Request pricing.",
  ...
  {
    match: ["iq577"],
    seoTitle: "Iridex IQ 577 Yellow Laser for Sale",
    seoDesc: "Iridex IQ 577 yellow retinal laser for sale, with MicroPulse for sub-threshold DME and CSC treatment near the fovea. Refurbished with warranty. Get a quote.",
  ...
  {
    match: ["iq532"],
    seoTitle: "Iridex IQ 532 Green Laser for Sale",
    seoDesc: "Iridex IQ 532 green photocoagulation laser for sale, for PRP, retinal tears and glaucoma, with MicroPulse on licensed units. Refurbished with warranty.",
  ...
  {
    match: ["iq810"],
    seoTitle: "Iridex IQ 810 Diode Laser for Sale",
    seoDesc: "Iridex IQ 810 infrared diode laser for sale, for cyclophotocoagulation, ROP treatment and MicroPulse retina therapy. Refurbished with warranty. Request a quote.",
  ...
  {
    match: ["cyclog6"],
    seoTitle: "Iridex Cyclo G6 Glaucoma Laser for Sale",
    seoDesc: "Iridex Cyclo G6 glaucoma laser for sale, for MicroPulse transscleral laser therapy and G-Probe cyclophotocoagulation. Refurbished with warranty. Get a quote.",
  ...
  {
    match: ["selecta"],
    seoTitle: "Lumenis Selecta II SLT Laser for Sale",
    seoDesc: "Lumenis Selecta II SLT laser for sale, the platform that established selective laser trabeculoplasty for glaucoma. Refurbished, calibrated and warranted.",
  ...
  {
    match: ["intralase"],
    seoTitle: "IntraLase iFS Femtosecond Laser for Sale",
    seoDesc: "Johnson & Johnson Vision IntraLase iFS 150 kHz femtosecond laser for sale, for predictable LASIK flaps and keratoplasty cuts. Refurbished with warranty.",
  ...
  {
    match: ["intuitiv"],
    seoTitle: "J&J Compact Intuitiv Phaco for Sale",
    seoDesc: "Johnson & Johnson Vision Compact Intuitiv phaco system for sale: a small console for cataract surgery in compact or mobile ORs. Refurbished with warranty.",
  ...
  // ---------------------------------------------------------------- Bausch + Lomb
  {
    ...
    seoTitle: "Bausch + Lomb Stellaris Elite for Sale",
    seoDesc: "Bausch + Lomb Stellaris Elite for sale: combined phaco and vitrectomy platform with adaptive fluidics and Vitesse on equipped units. Refurbished with warranty.",
  ...
  {
    match: ["stellaris"],
    seoTitle: "Bausch + Lomb Stellaris Phaco for Sale",
    seoDesc: "Bausch + Lomb Stellaris phaco system for sale, for micro-incision cataract surgery with vacuum and flow fluidics. Refurbished with warranty. Request a quote.",
  ...
  {
    match: ["endooptiks"],
    seoTitle: "Endo Optiks E2 ECP Laser for Sale",
    seoDesc: "Endo Optiks E2 laser endoscopy system for sale, for endoscopic cyclophotocoagulation (ECP) in glaucoma, often with cataract surgery. Refurbished with warranty.",
  ...
  {
    match: ["cso", "900"],
    seoTitle: "CSO SL 900 Slit Lamp for Sale",
    seoDesc: "CSO SL 900 series diagnostic slit lamp for sale, with quality Italian optics and optional digital imaging for anterior segment exams. Refurbished with warranty.",
...
export function withEditorialContent<T extends Fillable>(product: T): T {
  ...
  return {
    ...product,
    seoTitle: product.seoTitle?.trim() ? product.seoTitle : content.seoTitle ?? product.seoTitle,
    seoDesc: product.seoDesc?.trim() ? product.seoDesc : content.seoDesc ?? product.seoDesc,
